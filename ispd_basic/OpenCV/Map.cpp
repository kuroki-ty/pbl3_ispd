...
void Map::showMap2()
{
    ...
    tate=sqrt(abs(p1.x-p3.x)*abs(p1.x-p4.x)+abs(p1.y-p4.y)*abs(p1.y-p4.y));
    yoko=sqrt(abs(p1.x-p2.x)*abs(p1.x-p2.x)+abs(p1.y-p2.y)*abs(p1.y-p2.y));
