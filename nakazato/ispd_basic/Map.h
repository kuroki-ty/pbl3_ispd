...
// set method
	...
	void setCreateCoord(std::vector<Coordinate> coord)
	{
		this->create_point_list = coord;
	}
	void setobstacleCoord(std::vector<Coordinate> coord)
	{
		this->obstacle_point_list = coord;
	}
